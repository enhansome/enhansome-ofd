...
* [ofdrw](https://github.com/ofdrw/ofdrw) ⭐ 1,840 | 🐛 44 | 🌐 Java | 📅 2026-08-04 - OFD Reader & Writer 开源的OFD处理库，支持文档生成、数字签名、文档保护、文档合并、转换、导出等功能(Java)
* [easyofd](https://github.com/renoyuan/easyofd) ⭐ 438 | 🐛 58 | 🌐 Python | 📅 2026-06-11 - Python实现的OFD处理库纯 python的ofd解析与pdf转换(Python)
...
* [ofd.js](https://github.com/DLTech21/ofd.js) ⭐ 334 | 🐛 24 | 🌐 JavaScript | 📅 2024-08-13 - 基于JavaScript的OFD在线阅读器
